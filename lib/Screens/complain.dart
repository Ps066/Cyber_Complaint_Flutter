...
class _ComplaintPageState extends State<ComplaintPage> {
  ...
  Future uploadFile() async{
    final path = await 'Complaint Documents/${pickedFile!.name}';
                            ...
                            children: [
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                      onTap: () async {
                                        ...
                                        Reference referenceDirImages = referenceRoot.child("Cyber Complaint Images");
                              ...
                              InkWell(
                                onTap: () async {
                                  ...
                                  await FirebaseFirestore.instance.collection("Cyber Compalints").doc().set({
